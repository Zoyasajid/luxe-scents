...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (validate()) {
      ...
      alert('Login functionality is for UI demonstration only');
    }
  };
    ...
    <div className="min-h-screen bg-black py-12 flex items-center justify-center">
      <div className="w-full max-w-md">
        <div className="bg-charcoal-900 border border-charcoal-800 rounded-lg p-8">
          <h1 className="text-3xl font-bold mb-2 text-gold-500 text-center">Login</h1>
          <p className="text-charcoal-400 text-center mb-8">Welcome back to LUXE SCENTS</p>
